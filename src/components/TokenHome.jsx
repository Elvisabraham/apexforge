...
export default function TokenHome({
  ...
  return (
    <div className="w-full h-full bg-[#0c0d10] text-white overflow-hidden select-none relative">
      ...
      {/* ===================================================================== */}
      {/* 1. MOBILE NATIVE VIEW - FIXED OVERLAY COVERS NAVBAR */}
      {/* ===================================================================== */}
      <div className="flex lg:hidden fixed top-0 left-0 right-0 bottom-[60px] z-[45] bg-[#0c0d10] flex-col overflow-y-auto custom-scrollbar">
        
        {/* Mobile Top Navbar - Hides Global Header */}
        <div className="flex items-center justify-between p-3 border-b border-white/5 bg-[#0a0b0e] sticky top-0 z-30">
          <button 
            onClick={() => {
        ...
        <div className="p-4 bg-[#0c0d10] flex flex-col gap-4">
           ...
           <div className="grid grid-cols-4 gap-2 border-t border-white/5 pt-3">
              ...
              <div className="flex items-center justify-end gap-2.5 text-zinc-400">
                <a href={currentToken.twitter || "#"}><XIcon className="w-3.5 h-3.5 hover:text-white transition-colors" /></a>
                <a href={currentToken.telegram || "#"}><TelegramIcon className="w-3.5 h-3.5 hover:text-white transition-colors" /></a>
              </div>
           </div>
        </div>
      ...
      {/* ===================================================================== */}
      {/* 2. DESKTOP VIEW - EXACTLY AS YOU PROVIDED IT + DEX DOLLAR ICON */}
      {/* ===================================================================== */}
      <div className="hidden lg:grid grid-cols-12 h-full gap-2 p-2 w-full">
        
        {/* ==================== LEFT SIDEBAR ==================== */}
        <div className={`
          ${isSidebarOpen ? 'col-span-4 xl:col-span-3' : 'hidden'}
          flex flex-col h-full bg-[#121318] border border-white/5 rounded-xl overflow-hidden
        `}>
          ...
          <div className="p-2.5 border-t border-white/5 bg-[#0a0b0e] flex items-center justify-between shrink-0">
            ...
            <span className="flex items-center text-xs font-mono font-black text-[#00f2a1]">
              <DexDollarIcon className="w-3 h-3 mr-[1px]" strokeWidth={2.5} />
              99.60
            </span>
          </div>
        </div>
        ...
        <div className={`
          ...
          ${isSidebarOpen ? 'col-span-5 xl:col-span-6' : 'col-span-8 xl:col-span-9'}
        `}>
              ...
              <div>
                ...
                <div className="flex items-center gap-2 text-[10px] text-zinc-500 font-mono mt-0.5">
                  ...
                  <div className="flex items-center gap-2 text-zinc-400">
                    <a href={currentToken.website || "#"} target="_blank" rel="noreferrer" className="hover:text-white transition-colors"><svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9" /></svg></a>
                    <a href={currentToken.twitter || "#"} target="_blank" rel="noreferrer" className="hover:text-white transition-colors"><XIcon className="w-3.5 h-3.5" /></a>
                    <a href={currentToken.telegram || "#"} target="_blank" rel="noreferrer" className="hover:text-white transition-colors"><TelegramIcon className="w-3.5 h-3.5" /></a>
                  </div>
                </div>
              </div>
            </div>

            {/* Scrollable Right Ticker: Desktop */}
            <div className="flex items-center gap-6 overflow-x-auto scroll-smooth [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] font-mono shrink whitespace-nowrap">
              <div className="text-right shrink-0">
                ...
                <span className="flex items-center justify-end text-sm font-black text-white">
                  <DexDollarIcon className="w-3.5 h-3.5 text-zinc-400 mr-[1px]" strokeWidth={2.5} />
                  {String(currentToken?.price || '0.05439').replace('$', '')}
                </span>
              </div>
              <div className="text-right shrink-0">
            ...
            <div className="flex-1 flex flex-col overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
              ...
              <div className="p-3 border-b border-white/5 bg-[#0a0b0e] shrink-0">
                <div className="flex justify-between items-center mb-1">
                  ...
                  <span className="flex items-center text-xs font-mono font-black text-white">
                    <DexDollarIcon className="w-3 h-3 text-zinc-400 mr-[1px]" strokeWidth={2.5} />
                    349.5K
                  </span>
                </div>
              ...
              <div className="p-3 space-y-4">
                <div className="bg-[#121318] p-3 rounded-xl border border-white/5 font-mono">
                  ...
                  <div className="flex justify-between items-center text-[9px] text-zinc-500 mt-1.5">
                    <span className="flex items-center">
                      Graduate at <DexDollarIcon className="w-2.5 h-2.5 mx-0.5" strokeWidth={2.5}/> {currentToken?.targetMcap || '69k'} mcap
                    </span>
                    <span>{(currentToken?.bondingProgress ?? 72) >= 100 ? 'Graduated' : 'In Progress'}</span>
                  </div>
                </div>
                ...
                <div className="border-t border-white/5 pt-2">
                  ...
                  >
                    <span className="flex items-center"><DexDollarIcon className="w-2.5 h-2.5 mr-[1px]" strokeWidth={2.5}/> 0.12 + 0.85% fee</span>
