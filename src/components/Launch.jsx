...
export default function Launch({ onForgeSuccess }) {
  ...
  // 🚀 BULLETPROOF ON-CHAIN DEPLOYMENT HANDLER
  const handleRealDeployment = async () => {
    ...
    try {
      ...
      // 8. Execute Instruction (Triggers Wallet Modal)
        ...
        <div className="w-full max-w-2xl mx-auto flex flex-col gap-6">
          ...
          <div className="bg-gradient-to-br from-[#121212] to-[#0A0A0A] border border-[#089981]/30 rounded-3xl p-6 shadow-[0_0_30px_rgba(8,153,129,0.05)] relative overflow-hidden group">
            <div className="flex justify-between items-center border-b border-white/5 pb-3 mb-5">
              <h3 className="text-[11px] font-black text-[#089981] uppercase tracking-widest">⚡ Initial Snipe</h3>
            ...
            <div className="flex gap-2 mt-4 w-full">
               {['0.5', '1.0', '2.5', '5.0'].map(amt => (
                 <button key={amt} onClick={() => setInitialBuy(amt)} className="flex-1 py-3 bg-white/5 hover:bg-[#089981]/20 rounded-xl text-xs font-black text-zinc-300 hover:text-[#089981] border border-white/5 cursor-pointer">{amt}</button>
               ))}
            </div>
          </div>
          ...
          <div className="flex items-start gap-3 bg-[#121212] border border-white/10 p-4 rounded-xl">
            ...
            <p className="text-[10px] text-zinc-400 font-medium leading-relaxed">
              <strong className="text-white">Mandatory Disclosure:</strong> I acknowledge that assets deployed on Apex Forge are community digital art concepts intended strictly for entertainment.
            </p>
          </div>
