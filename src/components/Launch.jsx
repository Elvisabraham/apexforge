          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="space-y-1">
              ...
              <input
                ...
                /* Removed font-mono here to kill the crossed zero */
                className="w-full bg-[#0a0b0e] border border-white/10 focus:border-[#089981] rounded-xl px-3 py-2.5 text-xs text-white placeholder-zinc-600 outline-none transition-colors"
              />
            </div>
            ...
            <div className="space-y-1">
              ...
              <div className="relative flex items-center">
                <div className="absolute left-3 text-zinc-500">
                  <DexDollarIcon className="w-3.5 h-3.5" strokeWidth={3} />
                </div>
                <input
                  type="text"
                  placeholder="APEX"
                  ...
                  className="w-full bg-[#0a0b0e] border border-white/10 focus:border-[#089981] rounded-xl pl-8 pr-3 py-2.5 text-xs text-white placeholder-zinc-600 outline-none uppercase transition-colors"
                />
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#121318] border border-white/5 rounded-2xl p-4 space-y-3 shadow-xl">
            ...
            <div className="bg-[#0a0b0e] border border-white/5 rounded-xl p-3 flex items-center gap-3">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-xs text-[#00f2a1] font-bold truncate flex items-center mt-0.5">
                  <DexDollarIcon className="w-3 h-3 mr-[2px]" strokeWidth={3} />
                  {tokenSymbol || 'SYMBOL'}
                </p>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <input
                  ...
                  /* Removed font-mono here so 0.00 renders cleanly */
                  className="w-full bg-[#0a0b0e] border border-white/10 focus:border-[#089981] rounded-xl pl-3 pr-12 py-2.5 text-sm text-white placeholder-zinc-600 outline-none transition-colors"
                />
