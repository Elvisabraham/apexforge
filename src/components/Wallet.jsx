// 🚀 VERSION 4: THE INSTITUTIONAL WALLET WITH ISOLATED LEDGER ROOM
...
  
  // 🚀 FIXED: New State to open the dedicated Transaction History Room
...
  // 🚀 FIXED: Activity is permanently capped at 5 for the main dashboard view.
...
                    <>
                      {/* 🚀 FIXED: Always strictly maps the top 5 here */}
...
                      ))}
                      
                      {/* 🚀 FIXED: The 'See All' button now opens the dedicated Full Ledger Room */}
...
      {/* ------------------------------------------------------------- */}
      {/* --- 🚀 FIXED: DEDICATED FULL LEDGER ROOM (SEE ALL) -------- */}
      {/* ------------------------------------------------------------- */}
      {showFullHistory && (
...
                          <div className="flex justify-between items-center text-zinc-500 text-[10px] font-black uppercase tracking-[0.15em]">
                      ...
                      <div className="flex flex-col">
                        ...
                        <div className="text-center mb-6">
                          ...
                          <input type="text" value={depositAmount} placeholder="0" readOnly className="bg-transparent text-5xl font-sans font-bold text-white text-center w-full outline-none mt-2 placeholder:text-zinc-700" />
                        </div>
              ...
              <div className="flex flex-col animate-fadeIn h-full mt-2">
                ...
                <div className="text-center mb-6 mt-4">
                  <div className="flex justify-center items-center gap-2">
                    <input type="text" value={sendAmount} placeholder="0" readOnly className="bg-transparent text-5xl font-sans font-bold text-white text-center w-full max-w-[200px] outline-none placeholder:text-zinc-700" />
                    ...
                    {activeWithdrawMethodConfig.type === 'crypto' ? (
                      <>
                        ...
                        <div className="text-center mb-6 mt-2">
                          <div className="flex justify-center items-center gap-2">
                            <input type="text" value={withdrawAmount} placeholder="0" readOnly className="bg-transparent text-5xl font-sans font-bold text-white text-center w-full max-w-[200px] outline-none placeholder:text-zinc-700" />
                            <span className="text-xl font-bold text-zinc-500 mt-2">SOL</span>
                          </div>
                          <div className="text-[10px] font-black text-zinc-500 uppercase tracking-widest mt-4">Balance: {formatBalance((portfolio.find(a => a.symbol === 'SOL')?.balance) || 0)} SOL</div>
                        </div>
                      ...
                      <>
                        ...
                        <div className="text-center mb-6">
                          <span className="text-zinc-500 font-bold text-sm">$</span>
                          <input type="text" value={withdrawAmount} placeholder="0" readOnly className="bg-transparent text-5xl font-sans font-bold text-white text-center w-full outline-none mt-2 placeholder:text-zinc-700" />
            ...
            {activeModal === 'swap' && (
              <div className="flex flex-col animate-fadeIn h-full mt-2 relative">
                ...
                <div className="bg-[#121212] border border-white/10 rounded-3xl p-5 flex flex-col relative z-20 focus-within:border-[#089981]/50 transition-colors">
                  ...
                  <div className="flex justify-between items-center">
                    <input type="text" value={swapAmount} placeholder="0" readOnly className="bg-transparent text-4xl font-sans font-bold text-white outline-none w-1/2 placeholder:text-zinc-700" />
                ...
                <div className="bg-[#121212] border border-white/10 rounded-3xl p-5 flex flex-col relative z-10">
                  ...
                  <div className="flex justify-between items-center">
                    <input type="text" value={swapAmount ? formatNumber((parseFloat(swapAmount.replace(/,/g, '')) * 1.5).toFixed(2)) : ''} placeholder="0" readOnly className="bg-transparent text-4xl font-sans font-bold text-white outline-none w-1/2 placeholder:text-zinc-700" />
                    <div className="relative">
      ...
      {/* ------------------------------------------------------------- */}
      {/* --- SETTINGS SYSTEM INTEGRATION (Edit Profile / Settings) --- */}
      {/* ------------------------------------------------------------- */}
      {settingsView && (
