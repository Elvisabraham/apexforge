                  ...
                  <div className="flex items-center mt-0.5 w-full min-w-0">
                    {connected ? (
                      <button 
                        ...
                        className="flex items-center gap-1.5 group/copy hover:bg-white/5 py-1 px-1.5 -ml-1.5 rounded-lg transition-colors cursor-pointer max-w-fit min-w-0"
                        title="Copy Address"
                      >
                        ...
                        {/* 🚀 FIXED: Absolute titanium cage using flex-none */}
                        <div className="flex-none w-[14px] h-[14px] flex items-center justify-center">
                          {copied ? (
                            <svg className="w-full h-full text-[#00FF66]" fill="none" stroke="currentColor" strokeWidth={3} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg>
                          ) : (
                            <svg className="w-full h-full text-zinc-500 group-hover/copy:text-[#089981] transition-colors" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" /></svg>
                          )}
                        </div>
                      </button>
                    ) : (
