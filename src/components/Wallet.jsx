      ...
      <div className="flex flex-col w-full h-screen overflow-hidden bg-[#030303] text-white selection:bg-[#089981]/30 font-sans relative">
       ...
       {/* --- HEADER --- */}
        <header className="flex-none z-40 bg-[#030303]/90 backdrop-blur-3xl px-4 sm:px-6 py-3 border-b border-white/[0.02] flex items-center justify-between sticky top-0 relative overflow-hidden">
          ...
          <div className={`flex items-center min-w-0 z-10 max-w-[70%] sm:max-w-[50%] transition-all duration-300 ${isScrolled ? 'opacity-0 -translate-y-2 pointer-events-none' : 'opacity-100 translate-y-0'}`}>
                  ...
                  <div className="flex items-center mt-0.5 w-full min-w-0">
                    {connected ? (
                      <button 
                        ...
                        className="flex items-center gap-1.5 group/copy hover:bg-white/5 py-1 px-1.5 -ml-1 rounded-lg transition-colors cursor-pointer max-w-full"
                        title="Copy Address"
                      >
                      ...
                      <span className="text-[9px] text-zinc-500 font-black uppercase tracking-widest truncate mt-0.5">Disconnected</span>
                    )}
                  </div>
               </div>
            </div>
