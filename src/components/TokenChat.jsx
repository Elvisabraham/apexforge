...
const DexDollarIcon = ({ className, strokeWidth }) => (
...
// 🚀 GIF SEARCH STATES & ENGINE
  ...
  useEffect(() => {
    ...
    const fetchGifs = async () => {
      ...
      try {
        const apiKey = 'eCj0LAJGMa3WHLHvtB6f9MEx3YtUs6kL';
        ...
        <div className="fixed inset-0 z-[200] flex items-end justify-center bg-black/80 backdrop-blur-sm animate-fadeIn transition-opacity">
          ...
          >
            ...
            <div className="flex justify-between items-center mb-6">
              <div className="flex items-center gap-3">
            <img 
              src={displayToken?.image || displayToken?.imageUrl || displayToken?.imagePreview || displayToken?.logoURI || displayToken?.image_uri || displayToken?.icon || `https://api.dicebear.com/7.x/identicon/svg?seed=${displayToken?.symbol}`} 
