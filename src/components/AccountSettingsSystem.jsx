...
export default function AccountSettingsSystem({ 
  ...
  const [updateStatus, setUpdateStatus] = useState('v2.4.0 (Latest Version)');
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar pb-32">
        <div className="flex flex-col w-full mx-auto max-w-2xl">
          ...
          {activeView === 'wallet_drawer' && (
            <div className="w-full animate-fadeIn duration-200 pt-4">
          ...
          {activeView === 'main' && (
            <div className="w-full animate-fadeIn duration-200 pt-4">
              ...
              {/* Social Icons & Dynamic Update Version */}
              <div className="mt-8 flex flex-col items-center justify-center space-y-4">
                ...
                <button onClick={handleCheckUpdate} className="text-[10px] font-mono font-bold tracking-widest text-zinc-500 hover:text-[#089981] transition-colors">
                  {isCheckingUpdate ? 'Checking for updates...' : updateStatus}
                </button>
              </div>

              {/* Disconnect Button (Absolute Bottom) */}
          ...
          {activeView === 'export_warning' && (
            <div className="w-full animate-fadeIn duration-200 p-6 flex flex-col items-center text-center pt-8">
          ...
          {activeView === 'export_reveal' && (
            <div className="w-full animate-fadeIn duration-200 p-6 pt-8">
          ...
          {/* ==================================================== */}
          {activeView === 'about' && (
            <div className="w-full animate-fadeIn duration-200 p-6 flex flex-col items-center pt-10">
          ...
          {activeView === 'appearance' && (
            <div className="w-full animate-fadeIn duration-200 px-4 py-4 space-y-3 pt-4">
          ...
          {/* ==================================================== */}
          {activeView === 'legal' && (
            <div className="w-full animate-fadeIn duration-200 border-y border-white/5 bg-[#0A0A0A] mt-4">
              {[
